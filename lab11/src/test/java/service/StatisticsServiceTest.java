...
class StatisticsServiceTest {
    ...
    void getCompanyStatistics_WithValidCompany_ShouldReturnStatistics() {
        ...
        // Then - asercje dla statystyk firmy
        assertAll("Company statistics verification",
                ...
                () -> assertEquals(7000.0, result.getAverageSalary(), "Average salary should be 7000.0"),
                () -> assertEquals(10000.0, result.getMaxSalary(), "Max salary should be 10000.0"),
    ...
    void getCompanyStatistics_WithNonExistingCompany_ShouldReturnEmpty() {
        ...
        // Then - asercje dla nieistniejącej firmy
        assertAll("Non-existing company statistics",
                ...
                () -> assertEquals(0.0, result.getAverageSalary(), "Average salary should be 0"),
                () -> assertEquals(0.0, result.getMaxSalary(), "Max salary should be 0"),
    ...
    void getCompanyStatisticsDTO_WithValidCompany_ShouldReturnDTO() {
        ...
        assertAll("Company statistics DTO verification",
                ...
                () -> assertEquals(8000.0, result.getAverageSalary(), "Average salary should be 8000.0"),
                () -> assertEquals(12000.0, result.getHighestSalary(), "Highest salary should be 12000.0"),
                () -> assertEquals("Jan Manager", result.getTopEarnerName(), "Top earner name should match")
        );
    }
