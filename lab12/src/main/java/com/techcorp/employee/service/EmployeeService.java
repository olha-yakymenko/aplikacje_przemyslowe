...
public class EmployeeService {
    ...
    public CompanyStatistics getCompanyStatistics(String company) {
        ...
        if (dtoOpt.isPresent()) {
            ...
            CompanyStatistics stats = new CompanyStatistics(
                    dto.getCompanyName(),
                    Math.toIntExact(dto.getEmployeeCount()),
            ...
            return new CompanyStatistics(company, 0, BigDecimal.valueOf(0.0), BigDecimal.valueOf(0.0));
        }
    }
    ...
    @Transactional
    public boolean addEmployee(@Valid Employee employee) throws InvalidDataException {
        saveEmployee(employee);
        return true;
    }

    @Transactional
    public void addAllEmployees(@NotEmpty List<@Valid Employee> newEmployees) {
    ...
    public Employee createEmployee(@Valid Employee employee) throws InvalidDataException {
    ...
    public Employee saveEmployee(@Valid Employee employee) throws InvalidDataException {
    ...
    private void validateEmployee(@Valid Employee employee) throws InvalidDataException {
        if (employee == null) {
