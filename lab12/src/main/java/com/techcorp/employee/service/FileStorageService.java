...
public class FileStorageService {
    ...
    public String storeFileWithCustomName(
            @NotNull MultipartFile file,
            @NotBlank String subdirectory,
            @NotBlank String customFileName) {        validateFile(file);
    ...
    public Resource loadDocument(
            @NotBlank String fileName,
            @Email @NotBlank String employeeEmail) {        String subdirectory = "documents/" + normalizeFileName(employeeEmail);
