...
class EmployeeDocumentServiceTest {
    ...
    void storeDocument_WithValidPdf_ShouldStoreDocument() {
        ...
        // Then - użycie assertAll do grupowania asercji
        assertAll("Document storage verification",
    ...
    void storeDocument_WithValidWordDocument_ShouldStoreDocument() {
        ...
        // Then - ujednolicenie asercji
        assertAll("Word document storage verification",
                () -> assertNotNull(result),
                () -> assertEquals(storedFileName, result.getFileName())
        );
    }
    ...
    void getEmployeeDocuments_ShouldReturnOnlyDocumentsForSpecificEmployee() {
        ...
        // Then - grupowanie asercji dla obu list dokumentów
        assertAll("Employee documents verification",
    ...
    void getEmployeeDocuments_ShouldReturnEmptyListForEmployeeWithNoDocuments() {
        ...
        // Then - jedna asercja zamiast dwóch
        assertTrue(documents != null && documents.isEmpty(),
                "Should return an empty list for employee with no documents");
    }
    ...
    void getDocument_WithExistingId_ShouldReturnDocument() {
        ...
        // Then - użycie assertAll do grupowania asercji
        assertAll("Document retrieval verification",
    ...
    void documentExists_WithExistingId_ShouldReturnTrue() {
        ...
        // Then
        assertTrue(exists, "Document should exist for existing ID");
    }
    ...
    void documentExists_WithNonExistingId_ShouldReturnFalse() {
        ...
        // Then
        assertFalse(exists, "Document should not exist for non-existing ID");
    }
}