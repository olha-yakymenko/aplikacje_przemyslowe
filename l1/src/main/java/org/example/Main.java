...
import org.example.EmployeeManagementSystem;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n=== GRUPOWANIE WEDŁUG STANOWISKA ===");
        Map<Position, ?> grouped = system.groupEmployeesByPosition();
        grouped.forEach((position, employees) -> {
            System.out.println(position + ": " + employees);
        });
