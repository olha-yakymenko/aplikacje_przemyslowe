...
public class EmployeeDocumentService {
    ...
    public EmployeeDocument storeDocument(
            ...
            @NotNull(message = "Document type cannot be null") DocumentType documentType) {        // Validate employee exists
    ...
    public List<EmployeeDocument> getEmployeeDocuments(
            @NotBlank(message = "Employee email cannot be blank") String employeeEmail) {        return documents.values().stream()
    ...
    public EmployeeDocument getDocument(
            @NotBlank(message = "Document ID cannot be blank") String documentId) {        EmployeeDocument document = documents.get(documentId);
        if (document == null) {
