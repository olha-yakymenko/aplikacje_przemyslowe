...
//        return employeeDAO.findAll().stream()  // POPRAWIONE: findAll().stream() zamiast stream()
//                .collect(Collectors.groupingBy(
//                        Employee::getCompany,
//                        TreeMap::new,
...
//
//        // Zaktualizuj pracownika w bazie danych
...
//
//                // Wyczyść referencję do zdjęcia w bazie danych
//                Employee employee = employeeOpt.get();
...
public class EmployeeService {
    ...
    public CompanyStatistics getCompanyStatistics(String company) {
        ...
        // 👇 ZNAJDŹ PRACOWNIKA Z MAX PENSJĄ
