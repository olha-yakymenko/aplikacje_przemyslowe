...
public class DepartmentViewController {
    ...
    public String showAssignEmployeeForm(@PathVariable Long id, Model model) {
        Optional<Department> department = departmentService.getDepartmentById(id);
        if (department.isPresent()) {
    ...
    public String assignEmployeeToDepartment(@PathVariable Long id,
    ...
    public String removeEmployeeFromDepartment(@PathVariable Long departmentId,
