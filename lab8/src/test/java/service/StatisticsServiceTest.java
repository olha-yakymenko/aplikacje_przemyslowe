...
class StatisticsServiceTest {
    ...
    void getCompanyStatistics_WithValidCompany_ShouldReturnStatistics() {
        ...
        expectedStats.setHighestPaidEmployee("Jan Manager"); // 👈 DODAJ SETTER
        ...
        assertEquals("TechCorp", result.getCompanyName()); // 👈 DODAJ SPRAWDZENIE
        assertEquals(10000.0, result.getMaxSalary()); // 👈 DODAJ SPRAWDZENIE
    ...
    void getCompanyStatisticsDTO_WithValidCompany_ShouldReturnDTO() {
        ...
        companyStats.setHighestPaidEmployee("Jan Manager"); // 👈 DODAJ SETTER
    ...
    void getAllStatistics_WithZeroSalaries_ShouldCalculateCorrectly() {
        ...
        // highestPaidEmployee pozostanie "None" (domyślnie)
    ...
    // 👇 DODATKOWY TEST - sprawdzenie Optional w CompanyStatistics
    @Test
    void getCompanyStatistics_WithNoHighestPaidEmployee_ShouldReturnNone() {
        // Given
        CompanyStatistics expectedStats = new CompanyStatistics("TechCorp", 10, 7000.0, 10000.0);
        // Nie ustawiamy highestPaidEmployee - pozostanie Optional.empty() → "None"
        when(employeeService.getCompanyStatistics("TechCorp")).thenReturn(expectedStats);
