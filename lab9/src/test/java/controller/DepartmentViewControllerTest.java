...
public class DepartmentViewControllerTest {
    ...
    public void testShowDepartmentDocuments_DepartmentExists() throws Exception {
        // Given
        Department department = createDepartment(1L, "IT", "Warszawa", "Dział technologii", "manager@example.com", 100000.0);
        List<String> documents = Arrays.asList("raport_1704234567890_a1b2c3.pdf", "budget_1704234578901_d4e5f6.docx");
    ...
    public void testShowAssignEmployeeForm_DepartmentExists() throws Exception {
        ...
        List<Employee> availableEmployees = Arrays.asList(
                new Employee("Jan Kowalski", "jan@example.com", "TechCorp", Position.PROGRAMMER, 5000.0, EmploymentStatus.ACTIVE)
        );
    ...
    public void testAssignEmployeeToDepartment_Success() throws Exception {
        // Given
        doNothing().when(departmentService).assignEmployeeToDepartment("employee@example.com", 1L);
        ...
        verify(departmentService, times(1)).assignEmployeeToDepartment("employee@example.com", 1L);
    }
    ...
    public void testAssignEmployeeToDepartment_Exception() throws Exception {
        ...
        doThrow(new RuntimeException("Assignment error"))
                .when(departmentService).assignEmployeeToDepartment("employee@example.com", 1L);
    ...
    public void testRemoveEmployeeFromDepartment_Success() throws Exception {
        // Given
        doNothing().when(departmentService).removeEmployeeFromDepartment("employee@example.com");

        // When & Then
        mockMvc.perform(get("/departments/details/1/remove-employee/employee@example.com"))
                .andExpect(redirectedUrl("/departments/details/1"))
                .andExpect(flash().attributeExists("message"))
                .andExpect(flash().attribute("message", "Pracownik został usunięty z departamentu!"));

        verify(departmentService, times(1)).removeEmployeeFromDepartment("employee@example.com");
    }
    ...
    public void testRemoveEmployeeFromDepartment_Exception() throws Exception {
        ...
        doThrow(new RuntimeException("Removal error"))
                .when(departmentService).removeEmployeeFromDepartment("employee@example.com");
    ...
    public void testListDepartments() throws Exception {
        // Given
        Department department1 = createDepartment(1L, "IT", "Warszawa", "Dział technologii", "manager@example.com", 100000.0);
        Department department2 = createDepartment(2L, "HR", "Kraków", "Dział kadr", "hr@example.com", 50000.0);
        List<Department> departments = Arrays.asList(department1, department2);
    ...
    public void testUpdateDepartment_Success() throws Exception {
        // Given
        Department updatedDepartment = createDepartment(1L, "IT Updated", "Kraków", "Zaktualizowany dział", "newmanager@example.com", 120000.0);
